    ...
    public function get($id, $throwException = true)
    {
        ...
        if (isset($this->_definitions[$id])) {
            ...
            if (is_object($definition) && !$definition instanceof Closure) {
                ...
                return $this->_components[$id] = Ysf::createObject($definition);
            }
        } elseif ($throwException) {
            throw new \ysf\exception\InvalidConfigException("Unknown component ID: $id");
        } else {
            return null;
        }
    }
    ...
    public function set($id, $definition)
    {
        ...
        if (is_object($definition) || is_callable($definition, true)) {
            ...
            if (isset($definition['class'])) {
                ...
                throw new \ysf\exception\InvalidConfigException("The configuration for the \"$id\" component must contain a \"class\" element.");
            }
        } else {
            throw new \ysf\exception\InvalidConfigException("Unexpected configuration type for the \"$id\" component: " . gettype($definition));
        }
    }
